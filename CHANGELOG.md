...
- New tile property `mushymato.MMAP_CaskSpot`, allow casking at this tile.
...
### Fixed
- Cache tile to furniture for every location using location watcher, to fix overnight tile prop loss issues.
...
### Fixed
- Lights now get properly recreated for intra-map warps.
